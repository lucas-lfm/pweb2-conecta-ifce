    ...
    <section className="bg-card bg-soft-radial">
      <div className="container-main flex flex-col items-center text-center py-20">
        <div className="bg-muted border border-border py-1.5 px-4 flex items-center gap-2 rounded-full text-sm">
          ...
          <span className="text-muted-foreground"> Rede Social Acadêmica do IFCE</span>
        </div>

        <h1 className="mt-6 text-6xl text-balance font-bold text-foreground tracking-tight">
          Conecte-se, colabore e <span className="text-primary">cresça junto</span> com a comunidade IFCE
        </h1>

        <p className="mt-6 text-muted-foreground text-xl text-balance"> A plataforma que une alunos, professores e técnicos para compartilhar projetos, formar um grupo de estudos e celebrar conquistas acadêmicas.</p>
